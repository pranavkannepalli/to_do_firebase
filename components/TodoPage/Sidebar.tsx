...
const Sidebar: React.FC<Props> = ({ groups, signOut, allGroups, changeAllGroups, changeGroups, changeCurrentGroup }) => {
    ...
    const joinGroup = (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault();
        ...
        return (
            <div className="col-lg-3 col-sm-12 bgdark expandedSiderbar px-4">
                ...
                <div className="input-group">
                    ...
                    <button className="btn btn-outline-secondary" type="button" onClick={(e) => handleSubmit(e)}>
                ...
                <div className="input-group">
                    ...
                    <button className="btn btn-outline-secondary" type="button"onClick={(e) => joinGroup(e)}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
